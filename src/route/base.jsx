...
import PagePengeluaran from "../page/pengeluaran/pengeluaran";
import PagePresensi from "../page/presensi/presensi";
import PageOperasional from "../page/pengeluaran/operasional";
		...
		return (
			<div>
				<SideBar user={user} logout={this.logout}>
					...
					<Route path={Path.PageOperasional} component= { ( ) =>< PageOperasional legalAccess = { this.state.loggedAs === UserRole[0] || this.state.loggedAs === UserRole[1] } /> }/>
